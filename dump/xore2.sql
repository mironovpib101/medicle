...
--
-- Хост: localhost
-- Время создания: Янв 27 2019 г., 19:03
...
(1, 'Головная боль', '<p>Вот она - боль</p>', 167, 90),
(2, 'Мигрень', '<p>&nbsp;</p>', 210, 97),
(3, 'Боль в лице', '<p>&nbsp;</p>', 255, 180),
(4, 'Реабилитация после инсульта', '<p>&nbsp;</p>', 220, 300),
(5, 'Боли в суставах( артроз ,артрит)', '<p>&nbsp;</p>', 435, 135),
(6, 'Пяточная шпора', '<p>&nbsp;</p>', 700, 255),
(7, 'Остеохондроз,боль в спине,шее,пояснице', '<p>&nbsp;</p>', 50, 295),
(8, 'Восстановление нервов', '<p>&nbsp;</p>', 80, 150),
(9, 'Боли при фибромиалгии', '<p>&nbsp;</p>', 340, 555),
(10, 'Боль после операции на позвоночнике,боли после травм', '<p>&nbsp;</p>', 285, 400),
(11, 'Ночнои энурез', '<p>&nbsp;</p>', 400, 555),
(12, 'Нарушения сна', '<p>&nbsp;</p>', 130, 140),
(13, 'Вегетососудистая дистония', '<p>&nbsp;</p>', 160, 335);
